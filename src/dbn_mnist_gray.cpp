...
int main(int argc, char* argv[]){
    ...
    if(simple){
        ...
        typedef dbn::dbn<
            dbn::layer<dbn::conf<true, 100, true, true, dbn::DecayType::NONE, false, dbn::Type::GAUSSIAN, dbn::Type::NRLU>, 28 * 28, 300>,
            dbn::layer<dbn::conf<true, 100, false, true, dbn::DecayType::L2, false, dbn::Type::SIGMOID, dbn::Type::SIGMOID>, 300, 300>,
            //dbn::layer<dbn::conf<true, 100, false, true>, 400, 1100>,
            dbn::layer<dbn::conf<true, 100, false, true, dbn::DecayType::L2, false, dbn::Type::SIGMOID, dbn::Type::SOFTMAX>, 300, 10>> dbn_t;

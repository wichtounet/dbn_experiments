...
release: release/bin/rbm_mnist release/bin/rbm_mnist_view release/bin/crbm_mnist_view release/bin/dbn_mnist release/bin/dbn_mnist_gray release/bin/crbm_mnist
debug: debug/bin/rbm_mnist debug/bin/rbm_mnist_view debug/bin/crbm_mnist_view debug/bin/dbn_mnist debug/bin/dbn_mnist_gray debug/bin/crbm_mnist
